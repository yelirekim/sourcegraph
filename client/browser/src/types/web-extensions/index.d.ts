...
declare namespace browser.browserAction {
    ...
    const onClicked: Listener<tabs.Tab>
}
...
declare namespace browser.menus {
    ...
    const onClicked: EvListener<(info: OnClickData, tab: tabs.Tab) => void>

    const onHidden: EvListener<() => void>

    const onShown: EvListener<(info: OnClickData, tab: tabs.Tab) => void>
}
...
declare namespace browser.runtime {
    ...
    const onMessage: EvListener<OnMessageHandler>

    const onMessageExternal: EvListener<OnMessageHandler>
}
...
declare namespace browser.storage {
    ...
    const onChanged: EvListener<(changes: ChangeDict<any>, areaName: AreaName) => void>
}
...
declare namespace browser.windows {
    ...
    const onCreated: Listener<Window>
